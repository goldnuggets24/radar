...
var Card = React.createClass({
  ...
  render: function render() {
    ...
    var newChildren = React.Children.map(this.props.children, function (currentChild) {
      ...
      if (_this.props.initiallyExpanded === false && currentChild.props.expandable === true) return;
      ...
      if (currentChild.props.showExpandableButton === true) {
        doClone = true;
        newChild = React.createElement(CardExpandable, { expanded: _this.props.initiallyExpanded, onExpanding: _this._onExpandable });
      }
      if (doClone) {
