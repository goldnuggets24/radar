	...
	render: function() {
  		...
  		return (
			<div className="filter-buttons">
				...
				<Checkbox className="male" ref="White" value="White" name="checkboxName1" onCheck={this.handleChange} label="White"/>
				<Checkbox className="female" ref="Black" value="Black" name="checkboxName1" onCheck={this.handleChange} label="Black"/>
			</div>
		);
	}
});